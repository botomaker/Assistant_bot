...
dictionary_UA = {
    ...
    'show_month_events_txt2': 'Натисніть кнопку <strong>«Календар»</strong>, '
    ...
    'enter_date_name_show_events': 'Введіть назву події або дату у форматі день.місяць.рік, наприклад, "22.04.1999"',
    'nothing_find': 'За даним запитом нічого не знайдено',
    'event_deleted_success': 'Подію видалено!',
    'event_edited_text': 'Подію успішно редаговано!'
}
