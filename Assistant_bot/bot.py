...
from Handlers.Callback_Handlers.callback_handler import callback_handler_processing
from Handlers.Message_Handler.message_handler import message_handler
from PythonFiles import database as db
from PythonFiles.send_message import reply_message
from PythonFiles.functions import set_language_dict, set_default_values_entered_mode
...
# обрабатываются все остальные сообщения (фото, видео, стикеры, файлы)
